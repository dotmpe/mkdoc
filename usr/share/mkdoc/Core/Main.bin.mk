...
PY_MM_VERSION       := $(shell echo $(PY_FULL_VERSION) | sed 's/^\([0-9]\+\)\.\([0-9]\+\).*$$/\1.\2/g')
...
BIN                 += \
					   python$(PY_MMID_VERSION)=$(shell which python$(PY_FULL_VERSION))
else
BIN                 += \
					   python$(PY_MMID_VERSION)=$(shell which python)
endif
BIN                 += \
					   python=python$(PY_MMID_VERSION)
endif
